...
class DQN_agnt_0:
    def __init__(self, state_size, action_size):
        ...
        if load_model:
            self.model.load_weights(model_path + "/CNN_model_agnt_0.h5")
...
class DDQN_agnt_1:
    def __init__(self, state_size, action_size):
        ...
        if load_model:
            self.model.load_weights(model_path + "/CNN_model_agnt_1.h5")
...
class DDQN_agnt_2:
    def __init__(self, state_size, action_size):
        ...
        if load_model:
            self.model.load_weights(model_path + "/CNN_model_agnt_2.h5")
...
class Dueling_agnt_3:
    def __init__(self, state_size, action_size):
       ...
       # create main model and target model
        ...
        if load_model:
            self.model.load_weights(model_path + "/CNN_model_agnt_3.h5")
...
def main():
    ...
    while agnt_0.episode < 20:
        ...
        g_agent = pygame.image.load("g_agent.jpg")
        fig_2 = pygame.transform.scale(g_agent, (60, 60))
        
        g_agent_agent = pygame.image.load("g_agent_agent.jpg")
        fig_4 = pygame.transform.scale(g_agent_agent, (60, 60))
        
        g_agent_agent_landmark = pygame.image.load("g_agent_agent_landmark.jpg")
        fig_5 = pygame.transform.scale(g_agent_agent_landmark, (60, 60))
        
        g_agent_landmark = pygame.image.load("g_agent_landmark.jpg")
        fig_3 = pygame.transform.scale(g_agent_landmark, (60, 60))
        
        g_landmark = pygame.image.load("g_landmark.jpg")
        ...
        while not done and ep_step < 500:
            ...
            if game_arr[agnt_0_row][agnt_0_col] == 3:
                act_arr[0][0] = 4
            if act_arr[0][0] == 0:
                if game_arr[agnt_0_row+1][agnt_0_col] < 4:
                    agnt_0_row += 1
            if act_arr[0][0] == 1:
                if game_arr[agnt_0_row-1][agnt_0_col] < 4:
                    agnt_0_row -= 1
            if act_arr[0][0] == 2:
                if game_arr[agnt_0_row][agnt_0_col-1] < 4:
                    agnt_0_col -= 1
            if act_arr[0][0] == 3:
                if game_arr[agnt_0_row][agnt_0_col+1] < 4:
                    agnt_0_col += 1
            ...
            if act_arr[0][1] == 0:
                if game_arr[agnt_1_row+1][agnt_1_col] < 4:
                    agnt_1_row += 1
            if act_arr[0][1] == 1:
                if game_arr[agnt_1_row-1][agnt_1_col] < 4:
                    agnt_1_row -= 1
            if act_arr[0][1] == 2:
                if game_arr[agnt_1_row][agnt_1_col-1] < 4:
                    agnt_1_col -= 1
            if act_arr[0][1] == 3:
                if game_arr[agnt_1_row][agnt_1_col+1] < 4:
                    agnt_1_col += 1
            ...
            if act_arr[0][2] == 0:
                if game_arr[agnt_2_row+1][agnt_2_col] < 4:
                    agnt_2_row += 1
            if act_arr[0][2] == 1:
                if game_arr[agnt_2_row-1][agnt_2_col] < 4:
                    agnt_2_row -= 1
            if act_arr[0][2] == 2:
                if game_arr[agnt_2_row][agnt_2_col-1] < 4:
                    agnt_2_col -= 1
            if act_arr[0][2] == 3:
                if game_arr[agnt_2_row][agnt_2_col+1] < 4:
                    agnt_2_col += 1
            ...
            if act_arr[0][3] == 0:
                if game_arr[agnt_3_row+1][agnt_3_col] < 4:
                    agnt_3_row += 1
            if act_arr[0][3] == 1:
                if game_arr[agnt_3_row-1][agnt_3_col] < 4:
                    agnt_3_row -= 1
            if act_arr[0][3] == 2:
                if game_arr[agnt_3_row][agnt_3_col-1] < 4:
                    agnt_3_col -= 1
            if act_arr[0][3] == 3:
                if game_arr[agnt_3_row][agnt_3_col+1] < 4:
                    agnt_3_col += 1
